...
export interface ActionReducerMapBuilder<State> {
   ...
   *
   * @remarks
   * All calls to `builder.addCase` must come before any calls to
   * `builder.addMatcher` or `builder.addDefaultCase`.
   *
   ...
   * @remarks
   * All calls to `builder.addCase` must come before any calls to
   * `builder.addAsyncThunk`, `builder.addMatcher` or `builder.addDefaultCase`.
   *
   * @param actionCreator - Either a plain action type string, or an action creator generated by {@linkcode createAction} that can be used to determine the action type.
   * @param reducer - The actual case reducer function.
   */
  ...
  /**
   * Adds case reducers to handle actions based on an {@linkcode AsyncThunk}
   * action creator.
   *
   * @remarks
   * All calls to `builder.addAsyncThunk` must come after any calls to
   * `builder.addCase` and before any calls to `builder.addMatcher` or
   * `builder.addDefaultCase`.
   *
   * @param asyncThunk - The async thunk action creator itself.
   * @param reducers - A mapping from each of the {@linkcode AsyncThunk} action types to the case reducer that should handle those actions.
   *
   * @example <caption>Handle an async thunk's lifecycle actions</caption>
   *
   * ```ts no-transpile
  ...
  /**
   * Allows you to match your incoming actions against your own filter function
   ...
   * `builder.addCase` and `builder.addAsyncThunk` and before any calls to
   * `builder.addDefaultCase`.
   *
   ...
   * @param reducer - The actual case reducer function.
   *
   * @example <caption>Match actions with a type predicate function</caption>
   *
   * ```ts
  ...
  /**
   * Adds a "default case" reducer that is executed if no case reducer and no
   * matcher reducer was executed for this action.
   *
   * @param reducer - The fallback "default case" reducer function.
   *
   * @example <caption>Provide a fallback "default case" reducer</caption>
   *
   * ```ts
