...
Generate a config file with contents like
...
The config file may use any of the following extensions: `.js`, `.jsx`, `.mjs`, `.cjs`, `.ts`, `.tsx`, `.mts`, `.cts` or `.json`. Any other extension is rejected with the usage message.
